...
// I am deliberately recreating the HTML structure generated by PEAR::QuickForm - allows me to steal their CSS and make the site look harmonious
printf('<form action="%s" method="POST">',$_SERVER['PHP_SELF']);
echo '<fieldset><legend>Event</legend>';
...
foreach($visibleFields as $field) {
	...
	printf('<li><label for="%s" class="element">%s</label><div class="element">%s</div>%s</li>',$field,$field,$element,$extra);
	$extra='';
}
echo '</ol></fieldset></form>';
